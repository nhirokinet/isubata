...
$app->get('/initialize', function (Request $request, Response $response) {
    ...
    system('rm /home/isucon/isubata/webapp/public/icons/*');
    system('cp /home/yuta1024/isubata/icons/* /home/isucon/isubata/webapp/public/icons/');
...
{
    $passDigest = sha1(utf8_encode($password));
    $stmt = $dbh->prepare(
        "INSERT INTO user (name, salt, password, display_name, avatar_icon, created_at) ".
        "VALUES (?, ?, ?, ?, 'default.png', NOW())"
    );
    $stmt->execute([$userName, '', $passDigest, $userName]);
